...
class UserCreateTest(unittest.TestCase):
    ...
    def create_group_exists_test(self):
        ...
        self.assertRaises(ValueError, users.create_group, "test_group", root=self.tmpdir)
    ...
    def create_group_gid_exists_test(self):
        ...
        self.assertRaises(ValueError, users.create_group, "test_group", gid=47, root=self.tmpdir)
    ...
    def create_user_groups_gid_conflict_test(self):
        ...
        self.assertRaises(ValueError, users.create_user,
    ...
    def create_user_exists_test(self):
        ...
        self.assertRaises(ValueError, users.create_user, "test_user", root=self.tmpdir)
    ...
    def create_user_uid_exists_test(self):
        ...
        self.assertRaises(ValueError, users.create_user, "test_user", uid=1000, root=self.tmpdir)
    ...
    def set_root_password_test(self):
        ...
        password = "password2"
        users.set_root_password(password, isLocked=True, root=self.tmpdir)
        shadow_fields = self._readFields("/etc/shadow", "root")
        self.assertTrue(shadow_fields[1].startswith("!"))
        self.assertEqual(crypt.crypt(password, shadow_fields[1][1:]), shadow_fields[1][1:])
