...
class SubscriptionInterfaceTestCase(unittest.TestCase):
    ...
    def default_property_values_test(self):
        ...
        valid_roles = self.subscription_interface.GetValidRoles
        valid_slas = self.subscription_interface.GetValidSLAs
        valid_usage_types = self.subscription_interface.GetValidUsageTypes
