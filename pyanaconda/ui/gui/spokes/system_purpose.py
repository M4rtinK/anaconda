...
class SystemPurposeSpoke(NormalSpoke):
    ...
    def initialize(self):
        ...
        self._fill_listbox(self._usage_list_box,
                           ...
                           self._subscription_module.proxy.GetValidUsageTypes)
    ...
    def _add_row(self, listbox, original_value, name, button, clicked_callback):
        ...
        # - that way we can access the origian lvalue curresponding to
        ...
        label = Gtk.Label(label="<b>{}</b>".format(escape_markup(name)),
    ...
    def refresh(self):
        ...
        log.debug("SYSTEM PURPOSE REFRESH")
    ...
    def system_purpose_set(self):
        ...
        role = self._subscription_module.proxy.Role
        sla = self._subscription_module.proxy.SLA
        usage = self._subscription_module.proxy.Usage
        addons = self._subscription_module.proxy.Addons
        return any((role, sla, usage, addons))
    ...
    def apply(self):
        log.debug("SYSTEM PURPOSE APPLY")
