...
@dbus_error("SystemdDefaultTargetConfigurationError", namespace=ANACONDA_NAMESPACE)
class SystemdDefaultTargetConfigurationError(InstallationError):
    """Exception for systemd default target configuration errors."""
    pass
